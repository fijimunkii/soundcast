...
function addCastControls() {
  ...
  window.$soundcastClear = $ctrl.find('.clear-control');
  ...
  window.$soundcastClear.on('click', function() {
    window.soundcastQueue.clear()
    window.castApi.stopMedia();    
  });
}
...
css += '.clear-control { } .clear-control:before { background: url(https://a-v2.sndcdn.com/assets/images/header/volume-icons-a9c21b.png) 0 0 no-repeat !important; background-position: 0 -80px !important; } .clear-control:after { background-image: none !important; } .clear-control-container { bottom: 94px !important; }';
